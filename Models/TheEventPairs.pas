...
begin
  ...
  while not Table.EOF do begin
    ...
    { ≈сли событие вход то возможны два варианта:
      - врем€ входа уже записано - сохран€ем уже записанное врем€ входа как
        пару с нулевым выходом
      - врем€ входа еще не записано - записываем и ждем выход }
